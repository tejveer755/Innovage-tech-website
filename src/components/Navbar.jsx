...
const Navbar = () => {
  return (
    <div className="relative flex pt-16 items-center justify-center flex-row ">
      ...
      <nav className="relative flex md:flex-row justify-center gap-4 md:gap-24 rounded-full border-2 border-slate-400 bg-transparent bg-opacity-50 shadow-2xl  py-4 px-6 md:py-7 md:px-7 lg:mx-4 mx-0 md:w-auto text-slate-100 text-xl md:text-2xl w-fit font-medium bordr backdrop-blur-xl">
