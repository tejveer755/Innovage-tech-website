...
const Navbar = () => {
  return (
    <div className="relative flex pt-16 items-center justify-center flex-row ">
      ...
      <nav className="relative flex  md:flex-row justify-center gap-6 md:gap-24 rounded-full border-2 border-transparent bg-gray-200 bg-opacity-50 shadow-2xl dark:border-slate-600 dark:bg-transparent py-4 px-6 md:py-7 md:px-7 lg:mx-4 mx-0 md:w-auto text-slate-100 text-xl md:text-2xl w-3/4 font-medium backdrop-blur-xl">
