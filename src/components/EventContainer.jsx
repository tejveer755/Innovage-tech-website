...
const EventContainer = ({ colors, index }) => {
  return (
    ...
    >
      {/* Paragraph Section */}
      <div className="w-full text-center md:text-start md:w-1/2 py-20 px-8 md:px-16 mx-auto flex items-center justify-center  bg-gradient-to-tl from-zinc-300 via-slate-200 to-slate-100 bg-clip-text text-transparent  text-base font-medium sm:text-lg md:text-xl opacity-85 tracking-widest">
        <p>
      ...
      {/* Marquee Section */}
      <div className="relative overflow-hidden mx-auto md:mx-0 w-[90%] md:w-[50%] ">
